    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                {{-- Imprime avec la route existante admin.orders.receipt --}}
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('admin.orders.update-status', $order) }}" class="space-y-3">
                            ...
                            <button type="submit"
                                    class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-all">
                                Mettre à jour
                            </button>
                        </form>
                    </div>
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('admin.orders.update-payment-status', $order) }}" class="space-y-3">
                            ...
                            <button type="submit"
                                    class="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-all">
                                Mettre à jour
                            </button>
                        </form>
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-lg p-6 border-t-4 border-indigo-500">
                ...
                <div class="space-y-3">
                    ...
                    {{-- Imprimer le reçu : même route receipt --}}
                    <a href="{{ route('admin.orders.receipt', $order) }}"
