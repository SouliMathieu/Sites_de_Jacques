...
@section('content')
<div class="admin-products-burkina">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8 stat-card-bf">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Avec images</p>
                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Product::withImages()->count() }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 admin-table-bf">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($products as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            {{-- ✅ CORRIGÉ : Affichage du produit avec première image --}}
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    ...
                                    @if(!$product->hasImages() && !$product->hasVideos())
                                        <span class="text-gray-400 text-xs">Aucun média</span>
                                    @endif
                                </div>
                            </td>
                ...
                <div class="p-6">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-4">
                            ...
                            Cette action supprimera également toutes les images et vidéos associées.
                        </p>
                    </div>
                    <div class="flex space-x-3">
                        <button type="button"
